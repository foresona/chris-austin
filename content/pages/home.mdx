...
features:
  - title: Strategic Storytelling
    description: >-
      Craft compelling narratives that resonate with your audience and capture
      media attention
    icon: Sparkles
    gradient: from-purple-500 to-pink-500
  - title: Targeted Outreach
    description: >-
      Connect with the right journalists, influencers, and media outlets for
      maximum impact
    icon: Target
    gradient: from-blue-500 to-cyan-500
  - title: Crisis Management
    description: >-
      Navigate challenging situations with confidence and protect your brand
      reputation
    icon: MessageCircle
